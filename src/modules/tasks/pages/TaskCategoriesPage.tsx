...
import { useAllTaskCategories, useCreateTaskCategory, useSetTaskCategoryActive } from "@/hooks/useTaskCategories";
...
export function TaskCategoriesPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Task Categories" description="The database-driven category list every task is grouped under." />
      ...
      <Card>
        <CardContent className="p-6">
          {isLoading ? (
            ...
            <EmptyState icon={Tags} title="No categories yet" description="Add your first task category above." />
          ) : (
            <Table>
              <TableHeader>
                <TableRow>
