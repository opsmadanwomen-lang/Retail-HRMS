-- ============================================================================
-- Retail HRMS — Leave Management, Phase 4: leave_apply() — Long Leave Applied
-- notification
-- Migration 0114
--
-- Adds exactly one more notification (Long Leave Applied, to the employee)
-- on top of the 0109 body — every other line is byte-identical.
-- ============================================================================
